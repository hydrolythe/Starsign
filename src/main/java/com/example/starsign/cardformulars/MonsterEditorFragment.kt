...
class MonsterEditorFragment : Fragment()  {
    ...
    override fun onCreateView(
        ...
        val texts = listOf<List<Any>>(listOf(binding.titletextfield.text, monster.title), listOf(binding.lifetextfield.text, monster.life), listOf(binding.attacktextfield.text, monster.attack), listOf(binding.defensetextfield.text, monster.defense), listOf(binding.magicattacktextfield.text, monster.magicattack), listOf(binding.magicdefensefield.text, monster.magicdefense), listOf(binding.mptextfield.text, monster.mp))
        texts.forEach{t ->
            var edited = t.get(0)
            val text = t.get(1)
